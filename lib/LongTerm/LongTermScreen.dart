      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: LongTermList(searchQuery: _searchQuery,statusFilter: _selectedDropdownItem),
            ),
          ],
        ),
      ),
...
class LongTermList extends StatelessWidget {
  final String? searchQuery;
  final String? statusFilter;

  const LongTermList({Key? key, this.searchQuery, this.statusFilter}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        final data = snapshot.data?.docs.map((doc) => LongTermModel.fromSnapshot(doc)).toList();
